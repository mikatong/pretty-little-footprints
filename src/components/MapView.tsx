...
const getIconSvg = (iconType: MapIconType, accent: PlaceAccent, state: "lived" | "visited" | "selected") => {
  ...
  const shapes: Record<MapIconType, string> = {
    ...
    antarctica: `<path ${line} d="M5 36h38M8 32l10-17 6 11 5-17 11 23M12 36c6 2 18 2 25 0M18 15l3 10 4-4M29 9l1 17 5-5M8 40h35M10 43c7-2 20-2 28 0"/><path ${common} d="M30 36c-2-2-2-7 0-10 2-3 5-3 7 0 2 3 2 8 0 10z"/><path ${line} d="M31 30h5M34 26v10M30 36l-2 2M37 36l2 2"/>`,
